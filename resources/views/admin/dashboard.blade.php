            ...
            <div class="card mb-8">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button class="btn-secondary px-4 py-2 text-sm inline-flex items-center space-x-2" onclick="showReportsComingSoon()">>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button class="btn-secondary px-4 py-2 text-sm inline-flex items-center space-x-2" onclick="showSettingsComingSoon()">>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
