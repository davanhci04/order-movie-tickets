        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-blue-600 text-sm">ID: {{ $user->id }}</p>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.users.edit', $user) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200">
                    Chỉnh sửa
                </a>
                <a href="{{ route('admin.users.watchlist', $user) }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200">
                    Xem Watchlist
                </a>
            </div>
        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-4">
                                <div class="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-purple-600">{{ $user->watchlist->count() }}</p>
                        </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-yellow-600">{{ $user->ratings->count() }}</p>
                        </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600">{{ $user->comments->count() }}</p>
                        </div>
                ...
                <div class="p-6">
                                    ...
                                    @foreach($user->ratings->take(5) as $rating)
                                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div class="flex items-center space-x-1">
                                                ...
                                                <span class="font-semibold">{{ $rating->score }}/10</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    @if($user->ratings->count() === 0 && $user->comments->count() === 0)
                        <div class="text-center py-8">
                            <p class="text-gray-500">User chưa có hoạt động nào</p>
                        </div>
                    @endif
                </div>
            </div>
